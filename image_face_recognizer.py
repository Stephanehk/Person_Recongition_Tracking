...
def image_face_recognition():
    image_path ="/Users/2020shatgiskessell/Desktop/Missing_Child_Recognition/dataset/Jake/00001.jpg"
    #OpenCV modules
    ...
    modelPath = os.path.sep.join([detector_p,"res10_300x300_ssd_iter_140000.caffemodel"])
